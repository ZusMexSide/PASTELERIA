...
include_once '../backend/LEditarNoticia.php';
?>
                ...
                <div class="col-12 text-center">
                    ...
                    <form class="text-left"method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input placeholder="<?php echo $noticia['titulo'] ?>" name="titulo"type="text" class="form-control input" id="exampleInputEmail1">
                        </div>
                        <div class="form-group">
                            <label for="exampleInput">Noticia:</label>
                            <textarea placeholder="<?php echo $noticia['noticia'] ?>" name="noticia"type="text" class="form-control input" id="exampleInput"cols="30" rows="3"></textarea>
                        ...
                        <button name="enviado" value="Modificar"type="submit" class="btn btn-primary size mb-5">Modificar</button>
                        <br>
                        <a href="../administrador/panel.php" class="btn btn-primary btn-block size">Guardar y salir</a>
                    </form>
                </div>
            </div>
            </div>
