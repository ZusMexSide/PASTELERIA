...
if (isset($_FILES["imagen"])) {
    if (!empty($_FILES['imagen'])) {
        $galeria->subirFotoNueva($_FILES["imagen"]);
        header("Location: panel.php");
    }else {
    $error = "elige una foto para subir";
}
} 
?>
<!doctype html>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <form class="text-left"method="post" enctype="multipart/form-data">
                        ...
                        <button name="enviado" value="Modificar"type="submit" class="btn btn-primary size mb-5">Subir</button>
                    </form>
                </div>
            </div>
        </div>
