...
include_once '../backend/LeliminarFoto.php';
?>
<!doctype html>
<html lang="en">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h1> <?php echo '¿' . $_SESSION["autentificado"]["usuario"] . ' deseas eliminar la foto?' ?></h1>

                    <img class="mb-5 mt-5"src="<?php echo "../" . $foto['url'] ?>" alt="">
                    <br>
                    <form method="post">
                        <input type="hidden" name="id" value="<?php echo $foto['id'] ?>">
                        <input class="btn btn-primary size"type="submit" name="enviado" value="Aceptar">
                        <hr class="mb-5">
                        <a  class="btn btn-primary size"href="../administrador/panel.php">cancelar</a>
                    </form>
                </div>
            </div>
        </div>
