...
include_once '../backend/LeliminarNoticia.php';
?>
<!doctype html>
<html lang="en">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1 class="mb-5"> <?php echo '¿' . $_SESSION["autentificado"]["usuario"] . ' deseas eliminar la noticia?' ?></h1>

                        <img class="img-fluid mb-5" src="<?php echo "..".$noticia['url'] ?>" alt="">
                        <div class="text-center">
                            <h2 class="mb-3">Titulo: <?php echo $noticia['titulo'] ?></h2>
            <p class="mb-3">Noticia: <?php echo $noticia['noticia'] ?></p>
            </div>
            <div class="text-center">
                <form method="post">
                    ...
                    <br>
                    <br>
                    <input class="btn btn-primary size"type="submit" name="enviado" value="Aceptar">
                    <hr>
                    <a class="btn btn-primary size"href="panel.php">cancelar</a>
                </form>
                    </div>
                </div>
            </div>
